...
public final class BitmapUtils {
   ...
   */
  public static RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, Context context, Uri uri,boolean fromNotCrop) {
    ...
    return ei != null ? rotateBitmapByExif(bitmap, ei,fromNotCrop) : new RotateBitmapResult(bitmap, 0,fromNotCrop);
  }
   ...
   * New bitmap is created and the old one is recycled.
   */
  static RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, ExifInterface exif, boolean fromNotCrop) {
    int degrees;
    int orientation =
    ...
    return new RotateBitmapResult(bitmap, degrees, fromNotCrop);
  }
...
public   static final class BitmapSampled {
  ...
  /** The result of {@link #rotateBitmapByExif(Bitmap, ExifInterface, boolean)}. */
 public static final class RotateBitmapResult {
    ...
    RotateBitmapResult(Bitmap bitmap, int degrees, boolean fromNotCrop) {
      if (fromNotCrop) {
          try {
              this.bitmap = TransformationUtils.rotateImage(bitmap, degrees);
