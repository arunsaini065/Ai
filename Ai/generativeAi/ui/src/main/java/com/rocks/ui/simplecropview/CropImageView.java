...
import static com.rocks.ui.UiConfigKt.isOreoPlus;
...
import com.rocks.ui.simplecropview.animation.SimpleValueAnimator;
import com.rocks.ui.simplecropview.animation.SimpleValueAnimatorListener;
import com.rocks.ui.simplecropview.animation.ValueAnimatorV14;
import com.rocks.ui.simplecropview.animation.ValueAnimatorV8;
import com.rocks.ui.simplecropview.callback.Callback;
import com.rocks.ui.simplecropview.callback.CropCallback;
import com.rocks.ui.simplecropview.callback.LoadCallback;
import com.rocks.ui.simplecropview.callback.SaveCallback;
import com.rocks.ui.simplecropview.util.Logger;
import com.rocks.ui.simplecropview.util.Utils;
...
@SuppressWarnings("unused") public class CropImageView extends androidx.appcompat.widget.AppCompatImageView {
  ...
  private Uri saveImage(Bitmap bitmap, final Uri uri, boolean isFullScreen) throws IOException, IllegalStateException {
    mSaveUri = uri;
    if (mSaveUri == null) {
  ...
  public void loadAsync(final Bitmap sourceUri, final boolean useThumbnail,
                        final RectF initialFrameRect, final LoadCallback callback) {
      ...
      mExecutor.submit(new Runnable() {
        ...
        public void run() {
          try {
            ...
            final Bitmap sampled = sourceUri;
  ...
  public LoadRequest load(Bitmap sourceUri) {
    return new LoadRequest(this, sourceUri);
  }
    ...
    mExecutor.submit(new Runnable() {
      ...
      public void run() {
        ...
        try {
          ...
          saveImage(croppedImage, saveUri, false);
          ...
          mHandler.post(new Runnable() {
            ...
            public void run() {
              if (saveCallback != null){
                ...
                saveCallback.onSuccess(mSourceUri);
              }
            }
          });
        } catch (Exception e) {
   ...
   * @param isFullScreen
   */
  public void saveAsync(final Uri saveUri, final Bitmap image, final SaveCallback saveCallback, boolean isFullScreen) {
    try {
      ...
      mExecutor.submit(new Runnable() {
        ...
        public void run() {
          try {
            mIsSaving.set(true);
            saveImage(image, saveUri,isFullScreen);
  ...
  public enum CropMode {
    FIT_IMAGE(0), RATIO_4_3(1), RATIO_3_4(2), SQUARE(3), RATIO_16_9(4), RATIO_9_16(5), FREE(
        6), CUSTOM(7), CIRCLE(8), CIRCLE_SQUARE(9),ORIGINAL(10),
    PORTRAIT(11),STORY(12),POST(13),COVER(14), TRANSFORMS(15),TRANSFORMS_X(16),TRANSFORMS_Y(17);
